  ...
  <v-card subtitle="Web developer" title="Dirk Soentjens" :min-width="400">
    <v-list>
      ...
      <v-list-item>
        ...
        able to easily adapt to the documentation, standards and best practices
        of the frameworks I am asked to work with. I else enjoy trying out new
        ...
        can fully utilize my experience, learn and grow
        professionally.</v-list-item
      >
    </v-list>
  </v-card>
</template>
